...
import com.sistr.littlemaidrebirth.entity.iff.IFF;
import com.sistr.littlemaidrebirth.entity.iff.IFFTag;
import com.sistr.littlemaidrebirth.network.SyncIFFPacket;
...
public class IFFScreen extends Screen {
    ...
    public void renderAllMobs(MatrixStack matrices, int mouseX, int mouseY) {
        ...
        for (IFF iff : iffs) {
            ...
            drawString(matrices, font, iff.getIFFTag().getName(),
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (width / 4F < mouseX && mouseX < width - width / 4F) {
            ...
            if (Util.milliTime() - this.time < 250L) {
